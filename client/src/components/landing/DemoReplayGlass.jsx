/**
 * Glass box + video/timeline demo. Ported from the Framer code component
 * `BridgeDemoReplayGlass` (framer imports + property controls stripped);
 * self-contained styles kept verbatim for visual parity with bridge-jobs.com.
 */
...
const HIGHLIGHTS = [
    {
        startSec: 12,
        endSec: 45,
        category: "Reads requirements",
        label: "Read problem and constraints",
        description:
            "Candidate scrolled through full spec and noted time limit.",
        score: 8,
    },
    {
        startSec: 48,
        endSec: 120,
        category: "Uses AI effectively",
        label: "Gave a detailed prompt, then refined the output",
        description:
    ...
    },
    {
        startSec: 125,
        endSec: 180,
        category: "Tests and debugs",
        label: "Wrote test and fixed edge case",
        description: "Added unit test for empty input; fixed off-by-one.",
        score: 9,
    },
    {
        startSec: 200,
        ...
        label: "Extracted helper and error handling",
        description:
            "Pulled validation into a small function; added try/catch.",
        score: 8,
    },
    {
        startSec: 300,
        endSec: 340,
        category: "Uses AI effectively",
        label: "Reviewed AI suggestion before accepting",
        description: "Changed variable names and added a comment.",
        score: 8,
    },
]
...
function getActiveHighlightIndex(highlights, currentSec) {
    const inRange = highlights.findIndex(
        (h) =>
            currentSec >= h.startSec && currentSec <= (h.endSec ?? h.startSec)
    )
...
function Timeline({ activeIndex, playheadPct }) {
    return (
                ...
                return (
                    <div
                        ...
                        style={{
                            ...
                            transform:
                                activeIndex === i ? "scaleY(1.02)" : "scaleY(1)",
    ...
    return (
        <div className="bdrg-detail">
            ...
            >
                ...
                />
                <span className="bdrg-detail-cat">
                    {active.category ?? "Moment"}
                </span>
                {active.score != null && (
...
export default function DemoReplayGlass({
    ...
    const activeIndex =
        HIGHLIGHTS.length > 0
            ? getActiveHighlightIndex(HIGHLIGHTS, FIXED_SEC)
            : 0
    ...
    const timelineBlock = (
        <div className="bdrg-timeline-wrap">
            ...
            <Timeline activeIndex={activeIndex} playheadPct={playheadPct} />
    ...
    return (
        ...
        .bdrg-root, .bdrg-root * { box-sizing: border-box; margin: 0; }
      ...
      `}</style>
            ...
            <div className="bdrg-root">
                <div
                    className={`bdrg-glass${isHorizontal ? " bdrg-glass-horizontal" : ""}`}
                >
                    {/* Video / placeholder */}
                    <div className="bdrg-video-wrap">
                        ...
                        {REGIONS.map((r, i) => {
                            ...
                            return (
                                ...
                                >
                                    <div
                                        className="bdrg-region-edge bdrg-region-t"
                                        style={{ animationDelay: `${delay}s` }}
                                    />
                                    <div
                                        className="bdrg-region-edge bdrg-region-r"
                                        style={{
                                            animationDelay: `${delay + 0.28}s`,
                                        }}
                                    />
                                    <div
                                        className="bdrg-region-edge bdrg-region-b"
                                        style={{
                                            animationDelay: `${delay + 0.56}s`,
                                        }}
                                    />
                                    <div
                                        className="bdrg-region-edge bdrg-region-l"
                                        style={{
                                            animationDelay: `${delay + 0.84}s`,
                                        }}
                                    />
                                    <div
                                    ...
                                    />
                                    <span
                                        className="bdrg-region-label"
                                        style={{
                                            backgroundColor: r.border,
                                            animationDelay: `${delay + 1.35}s`,
                                        }}
                                    >
                                        {r.label}
                                    </span>

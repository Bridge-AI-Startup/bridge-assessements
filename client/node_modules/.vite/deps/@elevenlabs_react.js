...
var m = class _m extends c {
  ...
  static async create(e3) {
    ...
    try {
      ...
      } else i2 = `${a4}/v1/convai/conversation?agent_id=${e3.agentId}&source=${c3}&version=${r4}`;
      const h3 = ["convai"];
...
var M = class _M {
  ...
  static getDeviceIdConstraint(e3) {
    if (e3) return S() ? { ideal: e3 } : { exact: e3 };
  }
  constructor(e3, t, n2, o3, s2) {
...
var A = class _A extends r2 {
  static async startSession(e3) {
    ...
    if (null == (t = e3.useWakeLock) || t) try {
  ...
  static async streamFromMicrophone(e3, t) {
    try {
      ...
      m3.port.onmessage = (e4) => {
        ...
        let s3 = "";
        for (let e5 = 0; e5 < o4.length; e5++) s3 += String.fromCharCode(o4[e5]);
        const a4 = btoa(s3);

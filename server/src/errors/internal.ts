...
const NO_SERVICE_ACCOUNT_KEY =
  "Could not find service account key env variable";
...
export class InternalError extends CustomError {
  ...
  static NO_SERVICE_ACCOUNT_KEY = new InternalError(
    5,
    500,
    NO_SERVICE_ACCOUNT_KEY
  );
  ...
  static NO_GMAIL_CLIENT_SECRET = new InternalError(
    7,
    500,
    NO_GMAIL_CLIENT_SECRET
  );
  static NO_GMAIL_REDIRECT_URI = new InternalError(
    8,
    500,
    NO_GMAIL_REDIRECT_URI
  );
  static NO_GMAIL_ACCESS_TOKEN = new InternalError(
    9,
    500,
    NO_GMAIL_ACCESS_TOKEN
  );
  static NO_GMAIL_REFRESH_TOKEN = new InternalError(
    10,
    500,
    NO_GMAIL_REFRESH_TOKEN
  );
  static NO_GMAIL_TOKEN_EXPIRY = new InternalError(
    11,
    500,
    NO_GMAIL_TOKEN_EXPIRY
  );
